...
import { Input } from "@/components/ui/input"
 ...
 import { poppins } from "../../ui/fonts"
 import Image from "next/image"
 export default function Skills({ form }: any){
  return(
    <div>
    <FormField
        control={form.control}
        ...
        render={({ field }) => (
            <FormItem className="w-[90%]">
                <FormLabel className={`${poppins.className} text-xl font-medium m-5 ml-10`}>Technical Skills</FormLabel>
                <FormControl>
                    <Input placeholder="Technical skills" {...field} className="border-gray-400 border-1 focus:ring-2 ring-gray-400 w-full" />
                </FormControl>
                <FormMessage />
            </FormItem>
        ...
        render={({ field }) => (
            <FormItem className="w-[90%]">
                <FormLabel className={`${poppins.className} text-xl font-medium m-5 ml-10`}>Non-Technical Skills</FormLabel>
                <FormControl>
                    <Input placeholder="Non-technical skills" {...field} className="border-gray-400 border-1 focus:ring-2 ring-gray-400 w-full" />
                </FormControl>
                <FormMessage />
            </FormItem>
